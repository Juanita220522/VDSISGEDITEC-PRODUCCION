...
<body>
    ...
    <input type="text" id="searchInput" class="barrabusqueda" placeholder="Buscar proveedor..." onkeyup="filtrarProveedores()">
    ...
    <div class="button-container">
        <table id="proveedoresTable">
            ...
            <tbody id="proveedorTableBody">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" style="text-align:center;">No hay proveedores registrados</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <script>
        function filtrarProveedores() {
            ...
            const table = document.getElementById('proveedorTableBody');
